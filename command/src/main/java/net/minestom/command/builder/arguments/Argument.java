...
import net.minestom.command.builder.ArgumentCallback;
...
import net.minestom.command.builder.suggestion.SuggestionCallback;
...
public abstract class Argument<T> {
    ...
    public abstract @Nullable Key parser();
     ...
     * and used to retrieve the data when the command is parsed in {@link net.minestom.command.builder.CommandContext}.
     *
