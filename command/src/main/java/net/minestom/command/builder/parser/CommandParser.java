...
import static net.minestom.command.builder.parser.ArgumentParser.validate;
...
public final class CommandParser {
    ...
    public static void parse(CommandSender sender, @Nullable CommandSyntax syntax,
                             ...
                             @Nullable SortedMap<Integer, CommandSuggestionHolder> syntaxesSuggestions) {
    ...
    public static ArgumentQueryResult findEligibleArgument(CommandSender sender,
        ...
        SortedMap<Integer, ArgumentQueryResult> suggestions = new TreeMap<>(Collections.reverseOrder());
        ...
        final int max = suggestions.firstKey();
